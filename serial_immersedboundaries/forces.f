...
c     &          ,prsw(55000)
 ...
 201     format(10x,'At t=',e10.3,' write data on ',a20)
      ...
      risulM_x=0.
      sup_tot=0.0
      inv_uzero=1./(alx1*uzero*uzero)
      if (uzero.eq.0.)inv_uzero=1./alx1
...
c         vettnorm(1)=  vett32(2)*vett21(3)-vett21(2)*vett32(3)
         ...
         vettrif(3)=0.5  - bar3    ! PARTE DELICATA
...
c      write(*,*)' sup_tot, ne ',sup_tot,nb
     ...
     $     risult3_hat,risulM_x
      cx_v = 2.0*risul3_v*inv_uzero
      cy_v = 2.0*risul2_v*inv_uzero
      cz_v = 2.0*risul1_v*inv_uzero
      cx_p = 2.0*risul3_p*inv_uzero
      cy_p = 2.0*risul2_p*inv_uzero
      cz_p = 2.0*risul1_p*inv_uzero
      cM_x = 2.0*risulM_x*inv_uzero
