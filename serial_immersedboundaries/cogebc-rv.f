...
C          dqb2n(i,j)=-dt*(ga*dq2x2+ro*dq2x2o(i,j))
          ...
          if (i.eq.13.and.j.eq.2)write(94,*) 'boucdq -cost',
     $         ( uinfth(i,j)*sin(alphax) +
     $          wx*( x3c(n3)-x30 ) - uhy*cos(alphax) ),
     $         ( uinfth(i,j)*cos(alphax) -
     $          wx*( x2c(j)-x20 ) + uhy*sin(alphax) )
          if (i.eq.13.and.j.eq.2)write(94,*)'boucdq',i,dq2dx3,
     $         ( qb2n(i,j+1) - qb2n(i,j-1) )*0.5*udx2c(j),
     $         dq2x2,dq2x2o(i,j),dqb2n(i,j),qb2n(i,j)
          if (i.eq.14.and.j.eq.2)write(94,*)'boucdq',i,dq2dx3,
     $         ( qb2n(i,j+1) - qb2n(i,j-1) )*0.5*udx2c(j),
     $         dq2x2,dq2x2o(i,j),dqb2n(i,j),qb2n(i,j)
          if (i.eq.15.and.j.eq.2)write(94,*)'boucdq',i,dq2dx3,
     $         ( qb2n(i,j+1) - qb2n(i,j-1) )*0.5*udx2c(j),
     $         dq2x2,dq2x2o(i,j),dqb2n(i,j),qb2n(i,j)
          if (i.eq.16.and.j.eq.2)write(94,*)'boucdq',i,dq2dx3,
     $         ( qb2n(i,j+1) - qb2n(i,j-1) )*0.5*udx2c(j),
     $         dq2x2,dq2x2o(i,j),dqb2n(i,j),qb2n(i,j)
...
c     $         dq3x2o(i,j)
          ...
          if (i.eq.13.and.j.eq.2)write(98,*)'boucdq',i,dq3dx3,
     $         ( qb3n(i,j+1) - qb3n(i,j-1) )*0.5*udx2m(j),
     $         dq3x2,dq3x2o(i,j),dqb3n(i,j),qb3n(i,j)
          if (i.eq.13.and.j.eq.2)write(98,*)'dq3dx3',i,dq3dx3,
     $         q3(i,j,n3m-1),q3(i,j,n3m),qb3n(i,j)
          if (i.eq.14.and.j.eq.2)write(98,*)'boucdq',i,dq3dx3,
     $         ( qb3n(i,j+1) - qb3n(i,j-1) )*0.5*udx2m(j),
     $         dq3x2,dq3x2o(i,j),dqb3n(i,j),qb3n(i,j)
          if (i.eq.14.and.j.eq.2)write(98,*)'dq3dx3',i,dq3dx3,
     $         q3(i,j,n3m-1),q3(i,j,n3m),qb3n(i,j)
          if (i.eq.15.and.j.eq.2)write(98,*)'boucdq',i,dq3dx3,
     $         ( qb3n(i,j+1) - qb3n(i,j-1) )*0.5*udx2m(j),
     $         dq3x2,dq3x2o(i,j),dqb3n(i,j),qb3n(i,j)
          if (i.eq.15.and.j.eq.2)write(98,*)'dq3dx3',i,dq3dx3,
     $         q3(i,j,n3m-1),q3(i,j,n3m),qb3n(i,j)
          if (i.eq.16.and.j.eq.2)write(98,*)'boucdq',i,dq3dx3,
     $         ( qb3n(i,j+1) - qb3n(i,j-1) )*0.5*udx2m(j),
     $         dq3x2,dq3x2o(i,j),dqb3n(i,j),qb3n(i,j)
          if (i.eq.16.and.j.eq.2)write(98,*)'dq3dx3',i,dq3dx3,
     $         q3(i,j,n3m-1),q3(i,j,n3m),qb3n(i,j)
